...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'web@maniak.co'),
        'name' => env('MAIL_FROM_NAME', 'Maniak Website'),
    ],
