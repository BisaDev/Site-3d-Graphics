        ...
        killIt() {
            if (!this.wantsJob && !window.foundYourSecret) {
                ...
                if (this.death) {
                    ...
                    window.console.log(
                        '%cHello there, so you like looking under the hood?',
                    ...
                    window.console.info(
                        '%cthere might be something else here',
                        'font-size:10px;color:#FF1141'
                    )
                }
            }
        },
