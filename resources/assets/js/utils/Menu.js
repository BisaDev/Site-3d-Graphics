  ...
  static run() {
    ...
    document.addEventListener("scroll", function() {
      contentDivs.forEach(function(el) {
        ...
        if (_actPosition < stickyOffset.top && (_actPosition + parseInt(_elComputedStyle.height)) > 0) {
          sticky.classList.remove("menu-white", "menu-dark")
          sticky.classList.add(_isLight ? "menu-dark" : "menu-white");
          document.getElementById("logomaniak").src = _isLight ? "img/logos/maniak/logo-maniak-dark.svg" : "img/logos/maniak/logo-maniak-white.svg";
          return false;
        }
      });
    });
